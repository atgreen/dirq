...
type RegisterResponse struct {
	...
	FallbackIds   []string `protobuf:"bytes,15,rep,name=fallback_ids,json=fallbackIds,proto3" json:"fallback_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterResponse) GetFallbackIds() []string {
	if x != nil {
		return x.FallbackIds
	}
	return nil
}
...
type PeerResponse struct {
	...
	FallbackIds   []string `protobuf:"bytes,7,rep,name=fallback_ids,json=fallbackIds,proto3" json:"fallback_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PeerResponse) GetParentId() string {
	if x != nil {
		return x.ParentId
	}
	return ""
...
func (x *PeerResponse) GetFallbackIds() []string {
	if x != nil {
		return x.FallbackIds
	}
	return nil
...
type PeerUpdate struct {
	...
	// against the parent's TLS cert CN. Empty when new_role promotes the agent
	// to zone leader.
	NewParentId string `protobuf:"bytes,6,opt,name=new_parent_id,json=newParentId,proto3" json:"new_parent_id,omitempty"`
	// Agent IDs of the new fallback parents, index-aligned with new_fallback_addrs.
	NewFallbackIds []string `protobuf:"bytes,7,rep,name=new_fallback_ids,json=newFallbackIds,proto3" json:"new_fallback_ids,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *PeerUpdate) GetNewParentId() string {
	if x != nil {
...
func (x *PeerUpdate) GetNewFallbackIds() []string {
	if x != nil {
		return x.NewFallbackIds
	}
	return nil
}
...
type ExecRequest struct {
	...
	// relay_path is the chain of agent IDs from the zone leader down to this
	// request's target. Relays forward only to the next hop rather than to every
	// downstream peer, so the command, script, stdin or file body is seen by the
	// agents carrying it and by nobody else. Empty means "no route known" and
	// the older flood-downstream behaviour applies, which is what lets a
	// mixed-version fleet keep working in both directions.
	//
	// Highest field number in this message, deliberately: see the note on
	// ServerMessage.
	RelayPath     []string `protobuf:"bytes,16,rep,name=relay_path,json=relayPath,proto3" json:"relay_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecRequest) GetRelayPath() []string {
	if x != nil {
		return x.RelayPath
	}
	return nil
...
type PutFileRequest struct {
	...
	// Highest field number in this message, deliberately: see the note on
	// ServerMessage.
	RelayPath     []string `protobuf:"bytes,11,rep,name=relay_path,json=relayPath,proto3" json:"relay_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PutFileRequest) GetRelayPath() []string {
	if x != nil {
		return x.RelayPath
	}
	return nil
...
type FetchFileRequest struct {
	...
	// Highest field number in this message, deliberately: see the note on
	// ServerMessage.
	RelayPath     []string `protobuf:"bytes,9,rep,name=relay_path,json=relayPath,proto3" json:"relay_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FetchFileRequest) GetRelayPath() []string {
	if x != nil {
		return x.RelayPath
	}
	return nil
...
const file_proto_dirq_v1_dirq_proto_rawDesc = "" +
	...
	"\x1eserver_signing_public_keys_old\x18\r \x03(\fR\x1aserverSigningPublicKeysOld\x12\x1b\n" +
	"\tparent_id\x18\x0e \x01(\tR\bparentId\x12!\n" +
	"\ffallback_ids\x18\x0f \x03(\tR\vfallbackIds\"-\n" +
	...
	"\bagent_id\x18\x01 \x01(\tR\aagentId\"\xf7\x01\n" +
	"\fPeerResponse\x12'\n" +
	...
	"\bnew_role\x18\x05 \x01(\x0e2\x12.dirq.v1.AgentRoleR\anewRole\x12\x1b\n" +
	"\tparent_id\x18\x06 \x01(\tR\bparentId\x12!\n" +
	"\ffallback_ids\x18\a \x03(\tR\vfallbackIds\"\x8b\x05\n" +
	"\fAgentMessage\x122\n" +
	...
	"\aresults\x18\x02 \x03(\v2\x14.dirq.v1.QueryResultR\aresults\"\xb7\x02\n" +
	"\n" +
	"PeerUpdate\x12.\n" +
	...
	"\x0ftarget_agent_id\x18\x05 \x01(\tR\rtargetAgentId\x12\"\n" +
	"\rnew_parent_id\x18\x06 \x01(\tR\vnewParentId\x12(\n" +
	"\x10new_fallback_ids\x18\a \x03(\tR\x0enewFallbackIds\"\x85\x01\n" +
	...
	"\x04arch\x18\x05 \x01(\tR\x04arch\"\xec\x04\n" +
	...
	"scriptName\x12(\n" +
	"\x10target_agent_ids\x18\x0f \x03(\tR\x0etargetAgentIds\x12\x1d\n" +
	"\n" +
	"relay_path\x18\x10 \x03(\tR\trelayPath\x1a>\n" +
	...
	"\baap_user\x18\n" +
	" \x01(\tR\aaapUser\x12\x1d\n" +
	"\n" +
	"relay_path\x18\v \x03(\tR\trelayPath\"\xa2\x02\n" +
	...
	"\baap_user\x18\b \x01(\tR\aaapUser\x12\x1d\n" +
	"\n" +
	"relay_path\x18\t \x03(\tR\trelayPath\"\xdb\x01\n" +
